...
########################################################################################
class CLabelResultData(CImageResultData):
    ...
    def ProcessImages(
        ...
        *,
        ...
        self._dicImages = {}
        lTrgAction = [
            "/catharsys/action/std/blender/post-render/proc-label:1",
            "/catharsys/action/std/blender/post-render/proc-depth:1",
        ]

        dicRdrTypeName = {
            "/catharsys/action/std/blender/post-render/proc-label:1": "label",
            "/catharsys/action/std/blender/post-render/proc-depth:1": "depth",
        }

        dicTypes = {
            "label": ["Preview", "SemSeg"],
            "depth": ["Preview", "Radial", "AxisZ"],
        }
