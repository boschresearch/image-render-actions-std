...
def ResultData(xJobCfg: CConfigManifestJob):
    from .lib.cls_tonemap_result_data import CTonemapResultData

    return CTonemapResultData(xJobCfg=xJobCfg)
...
def Run(_xCfg: CConfigList) -> None:
    from .lib.cls_tonemap import CTonemap
    ...
    def Process(_xConstruct: CTonemap):
